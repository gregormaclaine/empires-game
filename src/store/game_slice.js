...
export const game_slice = createSlice({
  ...
  reducers: {
    ...
    beginning_character_picking: state => ({
      ...state,
      state_status: 'between'
    }),
    begin_character_picking: state => ({
      ...state,
      state_status: 'in',
      state: 'character-choosing'
    }),
    chosen_character: (state, { payload: character }) => ({
      ...state,
      character,
      state_status: 'between'
    }),
